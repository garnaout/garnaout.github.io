...
public interface Constants{ // MicroApplet2_0
	...
	static final double CACC_init = .2;  //  % of the vehicles arriving are CACC enabled (initial %)
	static final int CACC_MAX = 1;
	static final int CACC_MIN = 0;
	static final double HOV_rate = .2;
	...
	//static final double PKW_LENGTH_M= 1.80;  
	//static final double LKW_LENGTH_M= 1.; 
