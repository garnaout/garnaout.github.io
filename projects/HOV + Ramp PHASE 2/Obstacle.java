...
public class Obstacle implements Moveable{
    ...
    public MicroModel model(){return model;} // xxx
    ...
    public void setVelocity(double v){vel=v;}   // includes moving obstacle
	...
	return false;}
    public double dAcc(Moveable vwd, Moveable bwd){return 0.0;}
