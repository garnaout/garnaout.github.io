...
public class Car implements Moveable{
    ...
    // properties fixed for each car: color, (length,) index n
	...
	public void accelerate(double dt, Moveable vwd)
	{
		...
		if (vel<0.0)
		{
			Double tmp_double=new Double(vel);
			Double Out1=new Double(vwd.position()-pos);
			Out1=new Double(vwd.velocity());
			Integer Out2=new Integer(lane);
			Integer Out3=new Integer(vwd.lane());
			vel=0.0;
		}
	}
