...
public class MicroStreet implements Constants{
  ...
  static final int RIGHT=1;
    ...
    int exit__counter = 0;
    int imaxinit = (int)(0.001*RADIUS_M * 4 * Math.PI * DENS_MAX_INVKM + 200) * 7 ; // * 4 in order to fix the crash when we have too many agents in the system at one time (imax > imaxinit)
	...
	protected int translate(double dt, int choice_Szen)
	{
		...
		//System.out.println("---------------------- POSITION: -------------"+ ((Moveable)street.elementAt(i)).position());
